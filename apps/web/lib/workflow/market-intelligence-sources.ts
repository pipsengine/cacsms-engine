...
export const marketIntelligenceSources: DataSourceItem[] = [
  ...
  { id: "prop-rules", title: "Prop Firm Rules & Limits", description: "Daily loss, maximum drawdown, minimum days, trading restrictions and account rules.", status: "ACTIVE", required: true, color: "#EA580C", icon: "RULE", feedsInto: ["Stage 9", "Stage 16 audit/compliance"], failureImpact: "Prop account trading must be blocked." }
];
