...
function renderCard2(slug) {
  ...
  return `<section class="live-page">
    ...
    <div class="live-split"><article class="live-card"><h2>INTELLIGENCE PRODUCTION SCOPE</h2><p>This card transforms validated inputs into market, macro, sentiment, institutional, liquidity and account intelligence.</p><p>Configuration and connector management are intentionally excluded from Card 2.</p></article><article class="live-card live-gate"><h2>HANDOFF STATUS</h2><p><strong>${slug === "handoff" ? "Asset Scanner Input Package" : "Market Intelligence Package"}</strong></p><p>Next workflow card: 20-Asset Universe Scanner.</p><div class="live-actions"><a href="/workspace/data-sources-validation/dashboard">Review Card 1 Output</a><a href="/workspace/universe-scanner/dashboard">Open Card 3</a></div></article></div>
  </section>`;
}
