...
export const DATA_SOURCES = Object.freeze([
  ["market-data","Market Data Providers","market_data","Real-time Prices, Ticks, Depth","CACSMS Market Feed","ONLINE",true,18,100,22,0,"Stage 1","block_stage_1"],
  ["news-sentiment","News & Sentiment Sources","news_sentiment","News, RSS, AI Sentiment","CACSMS News Hub","ONLINE",true,22,100,38,0,"Stage 1","restrict_high_impact_trades"],
  ["economic-calendar","Economic Calendar","economic_calendar","Events, Indicators, Central Banks","CACSMS Calendar","SYNCED",true,45,98,42,0,"Stage 1","restricted_trading_mode"],
  ["social-sentiment","Social Media & Community","social_sentiment","Twitter, Reddit, Telegram","CACSMS Social Pulse","OPTIONAL",false,75,92,96,0,"Stage 1","reduce_confidence"],
  ["institutional-cot-data","On-Chain & Institutional Data","institutional_data","Whale Flow, COT, Volatility Index","CACSMS Institutional Feed","SCHEDULED",false,1800,94,0,0,"Stage 1","reduce_confidence"],
  ["historical-data","Historical Data","historical_data","OHLCV, Tick, Fundamentals","CACSMS Historical Store","ONLINE",true,120,100,12,0,"Stage 1","disable_historical_comparison"],
  ["broker-data","Broker Data","broker_data","Spread, Depth, Liquidity","CACSMS Broker Gateway","LIVE",true,12,100,18,0,"Stage 1","block_execution"],
  ["account-portfolio-data","Account & Portfolio Data","portfolio_data","Balance, Equity, Positions, Risk","CACSMS Portfolio Ledger","LIVE",true,15,100,16,0,"Stage 1","block_risk_validation"],
  ["prop-firm-rules","Prop Firm Rules & Limits","prop_rules","Drawdown, Daily Loss, Targets","CACSMS Compliance Rules","ONLINE",true,300,100,0,0,"Stage 1","block_prop_risk_validation"]
...
export function evaluateDataQualityGate(sources = DATA_SOURCES) {
  ...
  const healthScore = Math.round(sources.reduce((sum, source) => sum + source.healthScore, 0) / sources.length);
